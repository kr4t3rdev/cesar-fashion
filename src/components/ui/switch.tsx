  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="bg-background data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0 pointer-events-none block size-5 rounded-full ring-0 transition-transform"
      />
    </SwitchPrimitive.Root>
  );
}
